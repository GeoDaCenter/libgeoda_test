...
namespace {
    ...
    TEST(CLUSTERING_TEST, SKATER) {
        ...
        std::vector<std::vector<int> > clst = gda_skater(4, w, data, "euclidean", std::vector<double>(), -1, rand_seed);
        ...
        std::vector<std::vector<int> > clst_6 = gda_skater(6, w, data, "euclidean", std::vector<double>(), -1, rand_seed);
    ...
    TEST(CLUSTERING_TEST, REDCAP) {
        ...
        std::vector<std::vector<int> > clst = gda_redcap(4, w, data, method, "euclidean", std::vector<double>(), -1, rand_seed);
        double totalss = gda_totalsumofsquare(data);
        double withinss = gda_withinsumofsquare(clst, data);
        double ratio = (totalss - withinss) / totalss;
        ...
        std::vector<std::vector<int> > clst1 = gda_redcap(4, w, data, method, "euclidean", std::vector<double>(), -1, rand_seed);
        ...
        method = "fullorder-completelinkage";
        std::vector<std::vector<int> > clst2 = gda_redcap(5, w, data, method, "euclidean", std::vector<double>(), -1, rand_seed);
        ...
        std::vector<std::vector<int> > clst3 = gda_redcap(4, w, data, method, "euclidean", std::vector<double>(), -1, rand_seed);
        ...
        std::vector<std::vector<int> > clst4 = gda_redcap(4, w, data, method, "euclidean", std::vector<double>(), -1, rand_seed);
    ...
    TEST(CLUSTERING_TEST, MAXP_GREEDY) {
        ...
        int initial = 99;
        std::vector<std::vector<int> > clst = gda_maxp(w, data, bound_vals, min_bound, "greedy", initial, 0, 0,
